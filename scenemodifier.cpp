...
SceneModifier::SceneModifier( Qt3DCore::QEntity* foregroundEntity,
...

{
...

  {
    // Torus
    //! [3]
    m_torusEntity = new Qt3DCore::QEntity( foregroundEntity );
  ...
  coneTransform->setTranslation( QVector3D( 0.0f, 0.0f, 0.0f ) );
  ...
  // Cone
  {
    m_coneEntity = new Qt3DCore::QEntity( foregroundEntity );
  ...
  cylinderTransform->setTranslation( QVector3D( 0.0f, 0.0f, 2.0f ) );
  ...
  // Cylinder
  {
    m_cylinderEntity = new Qt3DCore::QEntity( middlegroundEntity );
  ...
  cuboidTransform->setTranslation( QVector3D( 0.0f, 0.0f, 2.0f ) );
  ...
  // Cuboid
  {
    m_cuboidEntity = new Qt3DCore::QEntity( middlegroundEntity );
  ...
  planeTransform->setTranslation( QVector3D( 0.0f, 0.0f, 4.0f ) );
  ...
  // Plane
  {
    m_planeEntity = new Qt3DCore::QEntity( backgroundEntity );
  ...
  sphereTransform->setTranslation( QVector3D( 0.0f, 0.0f, 4.0f ) );

  Qt3DExtras::QPhongMaterial* sphereMaterial = new Qt3DExtras::QPhongMaterial();
  sphereMaterial->setDiffuse( QColor( QRgb( 0xa69929 ) ) );

  // Sphere
  m_sphereEntity = new Qt3DCore::QEntity( backgroundEntity );
...
//! [4]
void
SceneModifier::enableTorus( bool enabled ) {
  m_torusEntity->setEnabled( enabled );
}
//! [4]

void
SceneModifier::enableCone( bool enabled ) {
  m_coneEntity->setEnabled( enabled );
}

void
SceneModifier::enableCylinder( bool enabled ) {
  m_cylinderEntity->setEnabled( enabled );
}

void
SceneModifier::enableCuboid( bool enabled ) {
  m_cuboidEntity->setEnabled( enabled );
}

void
SceneModifier::enablePlane( bool enabled ) {
  m_planeEntity->setEnabled( enabled );
}

void
SceneModifier::enableSphere( bool enabled ) {
